...
public class Ejercicios_practicos {
    ...
    */
    ...
    public static void preguntasQuizz() {
        ...
        preguntas[0][0] = "¿Que es Java?";
        preguntas[0][1] = "0";
        preguntas[1][0] = "¿Cómo permite Java un alto rendimiento?";
        preguntas[1][1] = "1";
     ...
     public static void incisosQuizz() {
        ...
        incisos[0][0] = "Un programa que esta disponible a partir de windows 10";
        incisos[0][1] = "Un lenguaje de programacion de bajo nivel";
        incisos[0][2] = "Un lenguaje de programacion de alto nivel";
        incisos[1][0] = "Usa el compilador Just in Time";
        incisos[1][1] = "Borra los procesos en segundo plano";
        incisos[1][2] = "Forza el uso de la Gpu";
